        ...
        <div className='p-4'>
            <div className='flex justify-between'>
                ...
                <div className='flex items-center'>
                  ...
                  <button ref={buttonRef} onClick={handleShowCardSettings} className='cursor-pointer hover:bg-gray-200 rounded-md p-1 dark:hover:bg-gray-700 ml-2'>
                    <BsGearFill className={`w-6 h-6 ${showCardSettings ? 'animate-pulse' : 'animate-none'}`}/>
                  </button>
                  {showCardSettings && <div ref={dropdownRef} className="absolute mt-40 right-5 mr-4 w-48 rounded-md shadow-lg z-40 bg-white dark:bg-gray-800 dark:border dark:border-gray-600">
