          ...
          <h1 className='font-bold text-4xl text-center text-gray-700 m-3'>Sign Up</h1>
            <div>
              ...
              <div>
                ...
                <input type='password' name='confirmPassword' autoComplete='off' className='border rounded-md text-xl w-full px-3 py-1 bg-gray-100' />
              </div>
              <button type='submit' className='text-xl text-white bg-orange-500 rounded-md py-2 w-full'>Create Account</button>
